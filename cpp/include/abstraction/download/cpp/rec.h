// Code generated by abstraction-idl from abstraction-download/download.thrift. DO NOT EDIT.
...
inline void pad(std::string& out, int depth) {
    out.append(static_cast<std::size_t>(depth) * 0, ' ');
}
...
inline std::string encode(const Failure& v) {
    std::string out;
    enc_failure(out, v, 0);
    out += '\n';
    return out;
...
inline Failure decode_failure(Reader& r);
...
inline Failure decode(std::string_view data) {
    Reader r{data};
    r.skip_ws();
    Failure v = decode_failure(r);
    r.skip_ws();
